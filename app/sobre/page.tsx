				...
				<div className='max-w-7xl mx-auto px-6'>
					<div className='max-w-4xl mx-auto'>
						<div className='prose prose-lg max-w-none'>
							<p className='text-g2b-gray leading-relaxed mb-6'>{t.about.content.text1}</p>

							<p className='text-g2b-gray leading-relaxed mb-6'>{t.about.content.text2}</p>

							<p className='text-g2b-gray leading-relaxed mb-8'>{t.about.content.text3}</p>
						</div>
					</div>
				</div>
			</section>
			...
			<section className='py-16 bg-gray-50'>
				<div className='max-w-7xl mx-auto px-6'>
					<div className='text-center mb-12'>
						<h2 className='text-3xl md:text-4xl font-bold text-g2b-purple mb-4'>Gisele Blak Bernat</h2>
						<p className='text-xl text-g2b-lightpurple font-semibold'>Fundadora e CEO da G2B</p>
					</div>
					...
					<div className='grid lg:grid-cols-3 gap-8 mb-12'>
						...
						<div className='lg:col-span-1'>
							<div className='bg-white rounded-2xl overflow-hidden shadow-xl'>
								<Image src='/images/gisele1.png' alt='Gisele Blak Bernat' width={400} height={533} className='w-full h-auto' />
							</div>
						</div>
						...
						<div className='lg:col-span-2'>
							<div className='bg-white rounded-2xl p-8 shadow-xl h-full'>
								...
								<div className='space-y-4 text-g2b-gray leading-relaxed'>
									<p>
										Gisele Blak Bernat é <strong>Mestre em Engenharia Civil de Produção</strong> com ênfase em Sistemas de Gestão,
										Produção e Qualidade pela UFF. <strong>Master Certificate in Project Management</strong> pela{' '}
									...
									<p>
										Fundou a G2B em 2008 com o objetivo de oferecer soluções customizadas em treinamento executivo e assessoria
										empresarial, ajudando organizações a alcançarem excelência em gestão.
									</p>

									<p>
										Ao longo de sua carreira, conduziu mais de 500 projetos de capacitação e consultoria, impactando positivamente
										milhares de profissionais em diversos setores da economia.
									</p>

									{/* Redes Sociais */}
									<div className='mt-8 pt-8 border-t border-gray-200'>
										<h4 className='text-xl font-bold text-g2b-purple mb-4'>Conecte-se</h4>
										<div className='flex flex-wrap gap-3'>
											<a
												href='https://www.linkedin.com/in/gisele-blak-bernat'
												target='_blank'
												rel='noopener noreferrer'
												className='flex items-center gap-2 bg-[#0077b5] text-white px-4 py-2 rounded-lg hover:bg-[#006399] transition-all shadow-sm'
											>
											...
											<a
												...
												target='_blank'
												rel='noopener noreferrer'
												className='flex items-center gap-2 bg-gradient-to-br from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white px-4 py-2 rounded-lg hover:opacity-90 transition-all shadow-sm'
											>
												<svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
											...
											<a
												...
												className='flex items-center gap-2 bg-g2b-purple text-white px-4 py-2 rounded-lg hover:bg-g2b-darkpurple transition-all shadow-sm'
											>
											...
											<a
												...
												target='_blank'
												rel='noopener noreferrer'
												className='flex items-center gap-2 bg-[#25D366] text-white px-4 py-2 rounded-lg hover:bg-[#1ebc59] transition-all shadow-sm'
											>
												<svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
								...
								<div className='md:col-span-2'>
									<div className='prose prose-lg max-w-none'>
										<div className='space-y-6 text-g2b-gray leading-relaxed'>
											<p>
												Gisele Blak Bernat é <strong>Mestre em Engenharia Civil</strong> de Produção com ênfase em Sistemas de
											...
											<p>
												Programa Internacional de Desarollo Gerencial pela Telefônica Móviles &amp; IEDE, na Espanha. MBA
												Executivo de Gestão de Negócios pelo IBMEC. Bacharel em Ciências com Dignidade Acadêmica &quot;cum
												laude&quot; pela UFRJ (Engenheira Civil).
											</p>
											...
											<div className='bg-g2b-yellow/10 border-l-4 border-g2b-yellow p-6 rounded-lg my-6'>
												...
												<p>
													...
													Gerenciamento de Projetos da Escola Politécnica da UFRJ e dos cursos de MBA em Gestão de Projetos e MBA
													em Gestão de Negócios Imobiliários e da Construção Civil da FGV. Autora de diversos artigos em
											...
											<div className='bg-purple-50 p-6 rounded-lg my-6'>
												...
												<p>
													...
													como projetos de implantação da rede GSM, implantação de plataformas de serviços de valor agregado
													(Caixa Postal, MMS, GTW VAS) e lançamento de produtos de marketing na Telefônica Celular/Vivo.
												</p>
											</div>
