		...
		<Layout>
			...
			<section className='bg-gradient-to-r from-g2b-purple to-g2b-darkpurple text-white py-16'>
				<div className='max-w-7xl mx-auto px-6 text-center'>
					<h1 className='text-4xl md:text-5xl font-bold mb-4'>Sobre a G2B</h1>
					<p className='text-xl text-gray-200'>Good to Be - Excelência em Gestão de Projetos desde 2008</p>
				</div>
			</section>
					...
					<div className='max-w-4xl mx-auto'>
						<div className='prose prose-lg max-w-none'>
							<p className='text-g2b-gray leading-relaxed mb-6'>
								A G2B ou <strong>&quot;Good to Be&quot;</strong> reflete as iniciais do nome de sua consultora fundadora Gisele
								Blak Bernat, hoje responsável por dirigir a empresa, estando a frente dos projetos de clientes da G2B.
							</p>

							<p className='text-g2b-gray leading-relaxed mb-6'>
								Com mais de 10 anos de atuação em Gerenciamento de Projetos em empresas de grande porte e uma larga experiência em
								treinamentos executivos por instituições de renome, Gisele Blak Bernat criou, em 2008, a G2B Treinamento Executivo
								&amp; Assessoria Empresarial LTDA., uma empresa com objetivo de atuar no segmento de Treinamento e Consultoria com
								foco em Gestão de Projetos nos diversos setores da economia.
							</p>

							<p className='text-g2b-gray leading-relaxed mb-8'>A G2B oferece em seu portfólio de soluções:</p>
						</div>
						...
						<div className='grid md:grid-cols-2 gap-6 mb-12'>
							...
							>
								...
								Capacitação
								<p className='text-sm font-normal mt-2 opacity-90'>Treinamentos e cursos especializados</p>
							</Link>
							<Link
								href='/assessoria'
							...
							>
								...
								Assessoria
								<p className='text-sm font-normal mt-2 opacity-90'>Consultoria em gestão de projetos</p>
							</Link>
						</div>
					</div>
				</div>
			...
			{/* Gisele Bio com Foto e Redes Sociais */}
			<section className='py-16 bg-gray-50'>
				<div className='max-w-7xl mx-auto px-6'>
					<div className='bg-white rounded-2xl shadow-xl overflow-hidden'>
						<div className='bg-gradient-to-r from-g2b-purple to-g2b-darkpurple text-white p-8'>
							<h2 className='text-3xl font-bold mb-2'>Gisele Blak Bernat, MSc, PMP</h2>
							<p className='text-g2b-yellow font-semibold'>Fundadora e Diretora Executiva</p>
						</div>
									...
									<div className='sticky top-24'>
										...
										<div className='relative mb-6'>
											<div className='w-full aspect-square bg-gradient-to-br from-g2b-purple to-g2b-lightpurple rounded-2xl flex items-center justify-center overflow-hidden'>
												{/* Placeholder para foto - você pode adicionar a imagem real aqui */}
												<div className='text-center p-8'>
													<svg className='w-32 h-32 mx-auto text-white/30' fill='currentColor' viewBox='0 0 24 24'>
														<path d='M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z' />
													</svg>
													<p className='text-white/50 text-sm mt-4'>Adicione foto aqui</p>
												</div>
											</div>
										</div>
										...
										<div className='bg-gray-50 rounded-xl p-6'>
											<h3 className='font-bold text-g2b-purple mb-4 text-center'>Conecte-se</h3>
											<div className='space-y-3'>
												...
												{/* WhatsApp */}
												<a
													href='https://wa.me/5522992335107'
													target='_blank'
													rel='noopener noreferrer'
					...
					<div className='mt-12 text-center'>
						...
						<p className='mt-4 text-g2b-gray'>Quer fazer parte da nossa equipe? Entre em contato!</p>
					</div>
				</div>
			</section>
		</Layout>
