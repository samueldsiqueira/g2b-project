...
export default function WhatsAppButton() {
  ...
  // Substitua pelo número de telefone da G2B (formato: 5521999999999)
  const phoneNumber = '5521999999999';
  const message = 'Olá! Gostaria de saber mais sobre as oficinas e soluções da G2B.';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Main button */}
        <motion.div
          className="relative w-16 h-16 bg-green-500 rounded-full shadow-lg flex items-center justify-center"
          animate={{
            boxShadow: isHovered 
        ...
        <motion.div
          ...
          className="absolute right-full mr-4 whitespace-nowrap bg-gray-900 text-white px-4 py-2 rounded-lg shadow-lg"
        >
