...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="min-h-screen bg-gradient-to-br from-g2b-purple via-g2b-purple-dark to-purple-900 relative overflow-hidden">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 lg:left-16 lg:translate-x-0 top-1/2 -translate-y-1/2 z-50 hidden lg:flex lg:flex-col lg:gap-8 lg:items-start">
